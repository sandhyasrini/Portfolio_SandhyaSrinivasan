...
function SideBarRight() {
  return (
    ...
    <div className="[writing-mode:vertical-rl] tracking-wide fixed bottom-0 left-auto right-[10px]">
      <a href="mailto:sandhya_srinivasan@outlook.com" className="invisible lg:visible email-id tracking-[0.1rem] relative text-sm text-white hover:text-[#009d68]">{email} </a>
    </div>
    // </div>
  );
}
